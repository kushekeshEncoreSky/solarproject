...
try {
    ...
    $sql = "INSERT INTO employees ( name, position, salary, department) VALUES 
            ( :name1, :position1, :salary1, :department1),
            ( :name2, :position2, :salary2, :department2),
            ( :name3, :position3, :salary3, :department3),
            ( :name4, :position4, :salary4, :department4),
            ( :name5, :position5, :salary5, :department5)";

...
<body>
    ...
    <h1 class="section-title" style="text-align: center;">Latest Posts</h1>
    <div class="container">
        <div class="grid">
            <?php
            $sql = "SELECT posts.*, users.username FROM posts JOIN users ON posts.user_id = users.id ORDER BY posts.created_at DESC LIMIT 9";
